...
>
> **更新**：2026-09-09（**P2.6 Batch 2**，见 `docs/history/106-p26-batch2-engine.md`；P2.9 Batch 1/2 见 104/105 号；权威逐条基线 `demo2/files2/97-launcher-1.0-final-audit.md`）。基线：715 tests 全绿 / zero warnings / topology 17 crates + 9 apps / S0=S1=S2=0 / Release Gate G01~G14 PASS / 1.0 manifest=released（签名待补）/ hotkey P50 307µs·P95 19.7ms / 10k UI soak PASS。
...
P26-A06       Graph Contract Kit                         ⏳ 未开始
...
```bash
cargo test --workspace          # 行为回归闸门（当前 715 全绿）
